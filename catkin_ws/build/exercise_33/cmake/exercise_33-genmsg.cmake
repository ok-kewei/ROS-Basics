...
message(STATUS "exercise_33: 1 messages, 0 services")

set(MSG_I_FLAGS "-Iexercise_33:/home/user/catkin_ws/src/exercise_33/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/exercise_33)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/exercise_33\")")
  # install generated code
  install(
