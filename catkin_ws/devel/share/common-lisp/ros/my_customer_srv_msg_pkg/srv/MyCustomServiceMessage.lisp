...
(cl:in-package my_customer_srv_msg_pkg-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <MyCustomServiceMessage-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MyCustomServiceMessage-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_customer_srv_msg_pkg-srv:<MyCustomServiceMessage-request> is deprecated: use my_customer_srv_msg_pkg-srv:MyCustomServiceMessage-request instead.")))

(cl:ensure-generic-function 'duration-val :lambda-list '(m))
(cl:defmethod duration-val ((m <MyCustomServiceMessage-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_customer_srv_msg_pkg-srv:duration-val is deprecated.  Use my_customer_srv_msg_pkg-srv:duration instead.")
  (duration m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MyCustomServiceMessage-request>)))
  ...
  "my_customer_srv_msg_pkg/MyCustomServiceMessageRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MyCustomServiceMessage-request)))
  "Returns string type for a service object of type 'MyCustomServiceMessage-request"
  "my_customer_srv_msg_pkg/MyCustomServiceMessageRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <MyCustomServiceMessage-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MyCustomServiceMessage-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_customer_srv_msg_pkg-srv:<MyCustomServiceMessage-response> is deprecated: use my_customer_srv_msg_pkg-srv:MyCustomServiceMessage-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <MyCustomServiceMessage-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_customer_srv_msg_pkg-srv:success-val is deprecated.  Use my_customer_srv_msg_pkg-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MyCustomServiceMessage-response>)))
  ...
  "my_customer_srv_msg_pkg/MyCustomServiceMessageResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MyCustomServiceMessage-response)))
  "Returns string type for a service object of type 'MyCustomServiceMessage-response"
  "my_customer_srv_msg_pkg/MyCustomServiceMessageResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MyCustomServiceMessage)))
  ...
  "my_customer_srv_msg_pkg/MyCustomServiceMessage")