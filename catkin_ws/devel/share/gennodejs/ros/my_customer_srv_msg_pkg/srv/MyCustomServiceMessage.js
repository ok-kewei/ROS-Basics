...
// (in-package my_customer_srv_msg_pkg.srv)
...
class MyCustomServiceMessageResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'my_customer_srv_msg_pkg/MyCustomServiceMessageResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'my_customer_srv_msg_pkg/MyCustomServiceMessage'; }
};
